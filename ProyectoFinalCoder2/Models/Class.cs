namespace EjemploDeClase
{
    ...
    public class Producto
    {
        ...
        public Producto(int id, string descripcion, double costo, double precio_de_venta, int stock, int id_usuario)
        {
            this.id = id;
    ...
    public class Producto_Vendido
    {
        ...
        public Producto_Vendido(int id_Producto_Vendido, int stock_ventas, int Id_Usuario, int id_producto2, int id)
        {
